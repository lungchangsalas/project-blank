...
*/
$config['tables']['users']           = 'user_users';
$config['tables']['groups']          = 'user_groups';
$config['tables']['users_accounts']  = 'user_users_accounts';
$config['tables']['users_groups']    = 'user_users_groups';
 ...
 */
$config['site_title']                 =  COMPANY_NAME;        // Site Title, example.com
$config['admin_email']                = COMPANY_EMAIL;    // Admin Email, admin@example.com
$config['default_group']              = 'members';           // Default group, use name
$config['admin_group']                = 'oficiales';             // Default administrators group, use name
...
$config['email_config']['useragent'] = 'Alajuelita';
...
$config['email_config']['wrapchars'] = 76;
$config['email_config']['mailtype'] = 'html';
$config['email_config']['charset'] = 'utf-8';
$config['email_config']['validate'] = FALSE;
$config['email_config']['priority'] = 3;
...
/*
 ...
 | Default: auth/
 */
$config['email_templates'] = 'email/Autenticacion/';
 ...
 */
$config['email_activate'] = 'activacion.php';
 ...
 */
$config['email_forgot_password'] = 'RecuperarContrasena.php';

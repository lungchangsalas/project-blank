...
class System_message {
	...
	// Set a warning message (clear other error messages)
	public function set_warning($msg, $save_to = 'flash'){
		$this->set('warning', $msg);
	}

	// Append warning message
	public function add_warning($msg, $save_to = 'flash')
	{
	...
	{
		$this->restore($from);
		return $this->render_by_type('success').$this->render_by_type('error').$this->render_by_type('warning');
	}
	...
	public function render_by_type($type)
	{
		...
		{
			$str.= "<div class='alert alert-$class_name alert-dismissible' role='alert'>";

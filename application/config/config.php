...
|
*/
$calledDomain = (!empty($_SERVER['HTTP_HOST'])) ? $_SERVER['HTTP_HOST'] : "";
$uri_path = parse_url($_SERVER['REQUEST_URI'] ?? '', PHP_URL_PATH);
$segments = explode('/', trim(parse_url($_SERVER['REQUEST_URI'] ?? '', PHP_URL_PATH), '/'));
$calledModule = $segments[0];

ob_start(); 
$default_domain  = APPLICATION_URL;
require('_allowed_domains.php');
...
$config['sess_cookie_name'] = '__Secure-_application_sessions';
//$config['sess_samesite'] = 'Lax';
$config['sess_expiration'] = 7200;
$config['sess_save_path'] = '_app_sessions';
...
$config['cookie_prefix']	= '__Secure-';
$config['cookie_domain']	= '.' . APPLICATION_URL;
$config['cookie_path']		= '/';
